    ...
    <body id="fondo">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item"><a href="#Funciones" class="nav-link px-2 text-white">Funciones</a>
                            </li>
                            <li class="nav-item"><a href="#NuestroEquipo" class="nav-link px-2 text-white">Nuestro
                                    Equipo</a></li>
        ...
        <main>
            ...
            <div class="container position-relative zindex-2 pt-5 pb-md-2 pb-lg-4 pb-xl-5">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-md-6 pt-lg-5 text-center text-md-start mb-4 mb-md-0">
                        ...
                        <a class="btn btn-warning" href="/registro/usuario" role="button"
                            id="btnInicial">Comencemos!</a>
                    </div>
                </div>
                ...
                <div class="card__giratorio col-md-4">
                    <div class="card__giratorio-conteudo">
                        ...
                        <div class="card__giratorio-conteudo--traseira">
                            <h2 class="">MISIÓN</h2>
                            <img src="https://i.postimg.cc/Qd39dHGf/Vector.png" alt="Icono de mision"
                                class="cartao__logo-pc">
            ...
            <div class="bodyCarrusel"> <!--Seccion de vista carrusel-->
                ...
                <section id="slider">
                    ...
                    <label for="s1" id="slide1">
                        <img src="../assets/img/1.png" height="100%" width="100%" id="img1">
                    ...
                    <label for="s4" id="slide4">
                        ...
                        <div class="color_textito centrar-texto-carru">
                            <h1>Guarda información</h1>
                            <h4>Si otro usuario publica algo de tu interés</h4>
                            <h4>guárdala para el futuro.</h4>
                        </div>
                    </label>
            ...
            <div class="row justify-content-evenly" style= "-webkit-text-fill-color: white; text-align: center;">
                <div class="border rounded border-warning col-2 resumen">
                    <img src="../assets/img/CursorClick.png" alt="Conectar">
                    <h5>Conecta</h5>
                </div>
                <div class="border rounded border-warning col-2 resumen">
                    <img src="../assets/img/Lamp.png" alt="Preguntar">
                    <h5>Pregunta</h5>
                </div>
                <div class="border rounded border-warning col-2 resumen">
                ...
                <div class="border rounded border-warning col-2 resumen">
                    <img src="../assets/img/Bookmark.png" alt="Guardar">
                    <h5>Guarda</h5>
                </div>
                <div class="border rounded border-warning col-2 resumen">
                    <img src="../assets/img/Share.png" alt="Compartir">
                    <h5>Comparte</h5>
                </div>
            </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <div class="pt-2">
                                                    ...
                                                    <li class="list-inline-item"><a
                                                            href="https://www.linkedin.com/in/carlos-ancapi-espinoza-657b5322a/"
                                                            target="_blank">
                                                            <img src="assets/img/linkedin.png" width="40px">
                                                    <li class="list-inline-item"><a
                                                            href="https://github.com/CarlosAncapi" target="_blank">
                                    ...
                                    <div class="col-lg-3 mb-4">
                                        ...
                                        <div class="row" id="SobreNosotros">
                                            <div class="col-md-12">
                                                <div class="img-hover-zoom">
                                                    <img src="https://i.postimg.cc/XYdYrgmb/Screenshot-85.png"
                                                        alt="wrapkit" class="img-fluid rounded-circle" id="Nosotros" />
                                                </div>
                                            </div>
                                            <div class="col-md-12 text-center">
                                                <div class="pt-2">
                                                    ...
                                                    <li class="list-inline-item"><a
                                                            href="https://www.linkedin.com/in/maria-teresa-bettoni-ramos-26206713b/"
                                                            target="_blank">
                                                            <img src="assets/img/linkedin.png" width="40px">
                                                    <li class="list-inline-item"><a
                                                            href="https://github.com/TeremotoBettoni" target="_blank">
                                                            <img src="assets/img/github.png" width="40px">
                                                    <li class="list-inline-item"><a
                                                            class="text-decoration-none d-block"><i
                                                                class="icon-social-behance"></i></a></li>
                                    ...
                                    <div class="col-lg-3 mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="img-hover-zoom">
                                                    <img src="https://i.postimg.cc/zX1J9h32/1670892743251.jpg"
                                            ...
                                            <div class="col-md-12 text-center">
                                                <div class="pt-2">
                                                    ...
                                                    <li class="list-inline-item"><a
                                                            href="https://www.linkedin.com/in/michel-espinoza-587138258/"
                                                            target="_blank">
                                                            <img src="assets/img/linkedin.png" width="40px">
                                                    <li class="list-inline-item"><a
                                                            href="https://github.com/MichelGeneration" target="_blank">
                                                            <img src="assets/img/github.png" width="40px">
                                                    <li class="list-inline-item"><a
                                                            class="text-decoration-none d-block"><i
                                                                class="icon-social-behance"></i></a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <div class="pt-2">
                                                    ...
                                                    <li class="list-inline-item"><a
                                                            href="https://www.linkedin.com/in/ivan-zapata-p/"
                                                            target="_blank">
                                                            <img src="assets/img/linkedin.png" width="40px">
                                                    <li class="list-inline-item"><a
                                                            href="https://github.com/littlesonik" target="_blank">
                                                            <img src="assets/img/github.png" width="40px">
                                                    <li class="list-inline-item"><a
                                                            class="text-decoration-none d-block"><i
                                                                class="icon-social-behance"></i></a></li>
                ...
                <div class="row" style="display: flex; justify-content: center;">
                    ...
                    <div class="col-md-4 my-5">
                        <div class="scroll-container" id="Contacto">
                            ...
                            <h5 style="color: white; margin-left: 10px; margin-top: 4px;"><img
                                    src="assets/img/iconocorreo.png" alt="Iconoi Correo" style="width: 40px;">
                                yoselocomparto@gmail.com</h5>
                        </div>
                    </div>
                    <div class="col-md-4 my-5">
